...
export const ColorPickerSelection = memo(
  ({ className, ...props }: ColorPickerSelectionProps) => {
    ...
    // Calcular posição inicial baseada em saturation e lightness
...
export const ColorPickerHue = ({
  ...
  return (
    ...
    >
      ...
      <Slider.Thumb className="block h-4 w-4 rounded-full border-2 border-primary/50 bg-background shadow transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring disabled:pointer-events-none disabled:opacity-50" />
    </Slider.Root>
  );
};
